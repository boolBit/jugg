package com.lorabit.view.people;
...
import com.lorabit.security.util.LoginUtil;
import com.lorabit.security.SessionManager;
import com.lorabit.security.LoginDetail.UserInfo;
...
public class LoginApi {
  ...
  public Map dologin(HttpServletRequest req, HttpServletResponse resp,
    ...
    if ("com/lorabit".equals(username) && "123456".equals(password)) {
      ret.put("success", "you hava logined");
      CurrentUser user = new CurrentUser();
      user.setIsApp(false);
      user.setUserInfo(new UserInfo(123l, "com/lorabit"));
